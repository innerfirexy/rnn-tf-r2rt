...
def plot_learning_curve(num_steps, state_size=4, epochs=1, verbose=False):
    ...
    losses, total_loss, final_state, train_step, x, y, init_state = basic_rnn.setup_graph(graph=g, config=config)
